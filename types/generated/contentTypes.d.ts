...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    community: Schema.Attribute.Component<'about.community', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    ourBoard: Schema.Attribute.Component<'about.board', false>;
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Component<'about.section', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiArticleDetailPageArticleDetailPage
  extends Struct.SingleTypeSchema {
  collectionName: 'article_detail_pages';
  info: {
    displayName: 'Article Detail Page';
    pluralName: 'article-detail-pages';
    singularName: 'article-detail-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::article-detail-page.article-detail-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCorporateMembershipPageCorporateMembershipPage
  extends Struct.SingleTypeSchema {
  collectionName: 'corporate_membership_pages';
  info: {
    displayName: 'Corporate Membership Page';
    pluralName: 'corporate-membership-pages';
    singularName: 'corporate-membership-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::corporate-membership-page.corporate-membership-page'
    > &
      Schema.Attribute.Private;
    partner: Schema.Attribute.Component<'home.partner', false>;
    premiumPartner: Schema.Attribute.Component<'home.partner', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    categoryNavbar: Schema.Attribute.Component<'header.category-navbar', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    premiumPartner: Schema.Attribute.Component<'home.partner', false>;
    publishedAt: Schema.Attribute.DateTime;
    secondSection: Schema.Attribute.Component<'home.section', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiImpulsInsightImpulsInsight extends Struct.SingleTypeSchema {
  collectionName: 'impuls_insights';
  info: {
    displayName: 'Impuls Insight Page';
    pluralName: 'impuls-insights';
    singularName: 'impuls-insight';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::impuls-insight.impuls-insight'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiLifeInSgLifeInSg extends Struct.SingleTypeSchema {
  collectionName: 'life_in_sgs';
  info: {
    displayName: 'Life In SG Page';
    pluralName: 'life-in-sgs';
    singularName: 'life-in-sg';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPastEventDetailPagePastEventDetailPage
  extends Struct.SingleTypeSchema {
  collectionName: 'past_event_detail_pages';
  info: {
    displayName: 'Past Event Detail Page';
    pluralName: 'past-event-detail-pages';
    singularName: 'past-event-detail-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPastEventPagePastEventPage extends Struct.SingleTypeSchema {
  collectionName: 'past_event_pages';
  info: {
    displayName: 'Past Event Page';
    pluralName: 'past-event-pages';
    singularName: 'past-event-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::past-event-page.past-event-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUpcomingEventDetailPageUpcomingEventDetailPage
  extends Struct.SingleTypeSchema {
  collectionName: 'upcoming_event_detail_pages';
  info: {
    displayName: 'Upcoming Event Detail Page';
    pluralName: 'upcoming-event-detail-pages';
    singularName: 'upcoming-event-detail-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::upcoming-event-detail-page.upcoming-event-detail-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiUpcomingEventUpcomingEvent extends Struct.SingleTypeSchema {
  collectionName: 'upcoming_events';
  info: {
    displayName: 'Upcoming Event Page';
...
export interface ApiVolunteerPageVolunteerPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    hero: Schema.Attribute.Component<'about.section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    volunteer: Schema.Attribute.Component<'volunteer.volunteer', true>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::article-detail-page.article-detail-page': ApiArticleDetailPageArticleDetailPage;
      ...
      'api::past-event-detail-page.past-event-detail-page': ApiPastEventDetailPagePastEventDetailPage;
      'api::past-event-page.past-event-page': ApiPastEventPagePastEventPage;
      ...
      'api::upcoming-event-detail-page.upcoming-event-detail-page': ApiUpcomingEventDetailPageUpcomingEventDetailPage;
